...
- (void)setupAllChildVC {
    [self setupChildVC:[[HomeViewController alloc] init] title:@"首页" image:@"tabbar_home"];
    
    MessageViewController* msgVC = [MessageViewController storyboardInitialWithName:@"Message"];
    [self setupChildVC:msgVC title:@"消息" image:@"tabbar_message_center"];
    
    [self setupChildVC:[[OrderViewController alloc] init] title:@"订单" image:@"Order"];
    
    ProfileViewController* mineVC = [ProfileViewController storyboardInitialWithName:@"Mine"];
